...
public class MainActivity3 extends WearableActivity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        filePath = Environment.getExternalStorageDirectory() + "/SensorData/" + subjectID + "/2";
        File file = new File(Environment.getExternalStorageDirectory()
                + "/SensorData/" + subjectID + "/2");
...
//            Date date = new Date(System.currentTimeMillis());
    ...
    public void dataCollector(View arg0) {
        ...
        if (buttonText.equals("Start")) {
            ...
            if (rep.equals(""))
                Toast.makeText(getApplicationContext(), "Please input the repetition",
                        Toast.LENGTH_SHORT).show();
            else {
